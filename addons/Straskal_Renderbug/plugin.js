"use strict";
{
  ...
  const PLUGIN_VERSION = "1.2.2.0";
  const PLUGIN_CATEGORY = "general";

  const PLUGIN_CLASS =
    (SDK.Plugins.Straskal_Renderbug = class Renderbug extends SDK.IPluginBase {
      constructor() {
        super(PLUGIN_ID);
        ...
        this._info.AddFileDependency({
          filename: "renderers/meshPolyRenderer.js",
          type: "external-runtime-script",
        });
        ...
        this._info.SetProperties([
          ...
          // Sprite mesh polygons
          new SDK.PluginProperty("group", "mesh-polys"),
          new SDK.PluginProperty("check", "draw-mesh", true),
          new SDK.PluginProperty("check", "mesh-solids-only", false),
          new SDK.PluginProperty("color", "mesh-color", [1, 1, 0]),
          new SDK.PluginProperty("percent", "mesh-opacity", 0.1),
        ]);
